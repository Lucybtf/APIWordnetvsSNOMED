...
*/
	...
	public void depthOfSynsetSubTreeTest() {
		...
		try {
			...
			LinkedHashMap<Synset, List<Synset>> tree = new LinkedHashMap<Synset, List<Synset>>();
	...
	public void depthnodesTest() {
		...
		try {
			...
			LinkedHashMap<Synset, List<Synset>> tree = new LinkedHashMap<Synset, List<Synset>>();
			tree = wordnetTest.getSubarbolWordnet(cat, 4, tree); // Testado con cat
			List<Synset> nodeslevel = wordnetTest.getHyponyms(cat);
	...
	public void NotContainsFirstInSecondTest() {
		...
		// System.out.print("RESULT"+wordnetTest.NotContainsFirstInSecond(tree1,
		// tree2));
		// System.out.print("RESULT"+wordnetTest.NotContainsFirstInSecond(tree2,
		// tree1));
	...
	public void getHyponymsTreeListTest() {
		...
		try {
			...
			List<Synset> synsets = wordnetTest.getHyponyms("ball", 9, POS.NOUN);
	...
	/*
	 * @Test public void RecorrerNodosTest(){
	 * 
	 * }
	 */
	...
	public void getSubarbolWordnetTest() throws JWNLException {
		...
		List<Synset> hyponyms = wordnetTest.getHyponyms(s1);
		LinkedHashMap<Synset, List<Synset>> expectedResult = new LinkedHashMap<Synset, List<Synset>>();
		expectedResult.put(s1, hyponyms);
		for (Synset a : hyponyms) {
			expectedResult.put(a, new ArrayList<Synset>());
		}

		LinkedHashMap<Synset, List<Synset>> treeResult = new LinkedHashMap<Synset, List<Synset>>();
