...
public class DistanceController {
	...
	@ResponseBody
	public double getWPDistanceAllSubTree(@PathVariable("offset1") Long offsetroot, @PathVariable("offset1") Long offset1, @PathVariable("offset2") Long offset2)
			throws JWNLException {
	...
	@ResponseBody
	public double getWPDistanceAllSubTree(@PathVariable("wordroot") String wordroot, @PathVariable("senseroot") int senseroot, @PathVariable("word1") String word1, @PathVariable("sense1") int sense1,
			@PathVariable("word2") String word2, @PathVariable("sense2") int sense2) throws JWNLException {
	...
	@ResponseBody
	public double getSanchezDistanceAllSubTree(@PathVariable("offsetroot") Long offsetroot, @PathVariable("offset1") Long offset1, @PathVariable("offset2") Long offset2)
			throws JWNLException {
		Synset root = wl.getSynset(offsetroot.longValue());
		Synset s1 = wl.getSynset(offset1.longValue());
		Synset s2 = wl.getSynset(offset2.longValue());
	...
	@ResponseBody
	public double getSanchezDistanceAllSubTree(@PathVariable("wordroot") String wordroot, @PathVariable("senseroot") int senseroot, @PathVariable("word1") String word1, @PathVariable("sense1") int sense1,
			@PathVariable("word2") String word2, @PathVariable("sense2") int sense2) {
		Synset root = wl.getSynset(wordroot, POS.NOUN, senseroot);
		Synset s1 = wl.getSynset(word1, POS.NOUN, sense1);
		Synset s2 = wl.getSynset(word2, POS.NOUN, sense2);
	...
	@ApiImplicitParam(name = "offset", value = "offset", dataType = DataType.LONG, paramType = ParamType.PATH)
	@ResponseBody
	public double getSanchezICAllSubTree(@PathVariable("offsetroot") Long offsetroot, @PathVariable("offset") Long offset) throws JWNLException, IOException {
		Synset root = wl.getSynset(offsetroot.longValue());
		Synset s1 = wl.getSynset(offset.longValue());
	...
	@ResponseBody
	public double getSanchezICAllSubTree(@PathVariable("wordroot") String wordroot, @PathVariable("senseroot") int senseroot, @PathVariable("word") String word1, @PathVariable("sense") int sense)
			throws JWNLException, IOException {
		Synset s1 = wl.getSynset(word1, POS.NOUN, sense);
		return distance.IC_measure(s1, wl);
	}
	...
	@ResponseBody
	public double getResniskDistanceAllSubTree(@PathVariable("offsetroot") Long offsetroot, @PathVariable("offset1") Long offset1, @PathVariable("offset2") Long offset2)
			throws JWNLException, IOException {
		Synset root = wl.getSynset(offsetroot.longValue());
		Synset s1 = wl.getSynset(offset1.longValue());
		Synset s2 = wl.getSynset(offset2.longValue());
	...
	@ResponseBody
	public double getResniskDistanceAllSubTree(@PathVariable("wordroot") String wordroot, @PathVariable("senseroot") int senseroot, @PathVariable("word1") String word1, @PathVariable("sense1") int sense1,
			@PathVariable("word2") String word2, @PathVariable("sense2") int sense2) throws JWNLException, IOException {
		Synset root = wl.getSynset(wordroot, POS.NOUN, senseroot);
		Synset s1 = wl.getSynset(word1, POS.NOUN, sense1);
		Synset s2 = wl.getSynset(word2, POS.NOUN, sense2);
	...
	@ResponseBody
	public double getLinDistanceAllSubTree(@PathVariable("offsetroot") long offsetroot, @PathVariable("offset1") long offset1, @PathVariable("offset2") long offset2)
			throws JWNLException, IOException {
	...
	@ResponseBody
	public double getLinDistanceAllSubTree(@PathVariable("wordroot") String wordroot, @PathVariable("senseroot") int senseroot, @PathVariable("word1") String word1, @PathVariable("sense1") int sense1,
			@PathVariable("word2") String word2, @PathVariable("sense2") int sense2) throws JWNLException, IOException {
		Synset root = wl.getSynset(wordroot, POS.NOUN, senseroot);
		Synset s1 = wl.getSynset(word1, POS.NOUN, sense1);
		Synset s2 = wl.getSynset(word2, POS.NOUN, sense2);
	...
	@ResponseBody
	public double getJianConrathDistanceAllSubTree(@PathVariable("offsetroot") long offsetroot, @PathVariable("offset1") long offset1, @PathVariable("offset2") long offset2)
			throws JWNLException, IOException {
		Synset root = wl.getSynset(offsetroot);
		Synset s1 = wl.getSynset(offset1);
		Synset s2 = wl.getSynset(offset2);
	...
	@ResponseBody
	public double getJianConrathDistanceAllSubTree(@PathVariable("wordroot") String wordroot, @PathVariable("senseroot") int senseroot, @PathVariable("word1") String word1, @PathVariable("sense1") int sense1,
			@PathVariable("word2") String word2, @PathVariable("sense2") int sense2) throws JWNLException, IOException {
		Synset root = wl.getSynset(wordroot, POS.NOUN, senseroot);
		Synset s1 = wl.getSynset(word1, POS.NOUN, sense1);
		Synset s2 = wl.getSynset(word2, POS.NOUN, sense2);
	...
	@RequestMapping(value = "/getjianConrathDistanceSnomedSubGraph/{id1}/{id2}", method = RequestMethod.POST, consumes = {
			"application/json" })
	@ResponseBody
	public double getjianConrathDistanceSnomedSubGraph(@PathVariable("id1") long id1, @PathVariable("id1") long id2,
			@RequestBody GraphSnomed graph) {
		LinkedHashMap<Long, Integer> g = sn.getSubGraph(graph);
	...
	@ResponseBody
	public double getWPDistanceSnomedAllSubTree(@PathVariable("rootid") Long rootid, @PathVariable("id1") Long id1, @PathVariable("id2") Long id2) {
