...
import com.proyectoapi.model.DistanceSnomed;
...
public class DistanceController {
	...
	@ResponseBody
	public double getWPDistance(@PathVariable("word1")String word1,@PathVariable("sense1")int sense1, @PathVariable("word2")String word2, @PathVariable("sense2") int sense2) {
	...
	@ResponseBody
	public double getSanchezDistance(@PathVariable("word1")String word1,@PathVariable("sense1")int sense1, @PathVariable("word2")String word2,@PathVariable("sense2") int sense2) {
		Synset s1 = wl.getSynset(word1, POS.NOUN, sense1);
		Synset s2 = wl.getSynset(word2, POS.NOUN, sense2);
		return distance.Sanchez_Distance(s1, s2, wl);
	}
