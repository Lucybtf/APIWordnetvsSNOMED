...
public class WordnetLibraryController {
	...
	@ApiOperation(value = "Get Hypernyms Words", tags = "getHypernyms")
	@RequestMapping(value = "/getHypernymsWords/{word}/{sense}", method = RequestMethod.GET, produces = {
			"text/plain" })
	...
	public String getHolonyms(@PathVariable("word") String word, @PathVariable("sense") int sense)
			throws JWNLException {
	...
	public String getHolonymsWords(@PathVariable("word") String word, @PathVariable("sense") int sense)
			throws JWNLException {
		ArrayList<Synset> holonyms = wl.getHolonyms(word, sense, POS.NOUN);
		return holonyms.toString();
	}
	...
	public String getMeronyms(@PathVariable("word") String word, @PathVariable("sense") int sense)
			throws JWNLException {
	...
	public String getMeronymsWords(@PathVariable("word") String word, @PathVariable("sense") int sense)
			throws JWNLException {
	...
	@ApiOperation(value = "Check if the entity node", tags = "checkIfEntityNode")
	@RequestMapping(value = "/isEntityNode/{word}/{sense}", method = RequestMethod.GET, produces = {
			"application/json" })
	@ResponseBody
	...
	@ApiOperation(value = "Get List of Synsets until entity", tags = "getPathToEntity")
	@RequestMapping(value = "/getPathToEntity/{word}/{sense}", method = RequestMethod.GET, produces = {
			"application/json" })
	...
	@RequestMapping(value = "/getPathBetweenSynsets/{offset}", method = RequestMethod.GET, produces = {
			"application/json" })
	...
	@ApiOperation(value = "Get path between two synsets", tags = "getPathBetweenSynsets")
	@RequestMapping(value = "/getPathBetweenSynsets/{word}/{sense}", method = RequestMethod.GET, produces = {
			"application/json" })
	public String getPathBetweenSynsets(@PathVariable("word") String word, @PathVariable("sense") int sense)
			throws JWNLException {
		Synset s = wl.getSynset(word, POS.NOUN, sense);
		ArrayList<String> synsets = wl.getListofSynsetsToString(wl.getPathToEntity(s));
		JSONArray jsArray = new JSONArray(synsets);
	...
	@RequestMapping(value = "/getNumLinksBetweenSynsets/{offset}", method = RequestMethod.GET, produces = {
			"text/plain" })
	...
	@ApiOperation(value = "Get number of links between two synsets", tags = "getPathBetweenSynsets")
	@RequestMapping(value = "/getNumLinksBetweenSynsets/{word}/{sense}", method = RequestMethod.GET, produces = {
			"text/plain" })
	...
	@ApiOperation(value = "Get depth of a synset", tags = "getdepthOfSynset")
	@RequestMapping(value = "/getdepthOfSynset/{word}/{sense}", method = RequestMethod.GET, produces = {
			"application/json" })
	@ResponseBody
	...
	@RequestMapping(value = "/getLCS/{offset1}/{offset2}", method = RequestMethod.GET, produces = {
			"application/json" })
	...
	@ApiOperation(value = "Get Least Common Subsummer", tags = "getLCS")
	@RequestMapping(value = "/getLCS/{word1}/{sense1}/{word2}/{sense2}", method = RequestMethod.GET, produces = {
			"application/json" })
	...
	@RequestMapping(value = "/getSubtreeByOffset/{offset}/{depth}", method = RequestMethod.POST, produces = {
			"application/json" })
	...
	@ApiOperation(value = "Get SubTree of Wordnet", tags = "getSubtree")
	@RequestMapping(value = "/getSubtree/{offset}/{depth}", method = RequestMethod.POST, produces = {
			"application/json" })
	...
	@ApiOperation(value = "Get SubTree of Wordnet", tags = "getSubtree")
	@RequestMapping(value = "/getSubtree/{word}/{sense}/{depth}", method = RequestMethod.POST, produces = {
			"application/json" })
	public String getSubtree(@PathVariable("word") String word, @PathVariable("sense") int sense,
			@PathVariable("depth") int depth) throws JWNLException, IOException {
	...
	@RequestMapping(value = "/getdepthOfSynsetinSubtree/{offset}", method = RequestMethod.POST, consumes = {
			"application/json" })
	@ApiImplicitParam(name = "offset", value = "offset", dataType = DataType.LONG, paramType = ParamType.PATH)
	@ResponseBody
	public int getdepthOfSynsetinSubtree(@PathVariable("offset") Long offset, @RequestBody Tree treeResult)
			throws JWNLException {
